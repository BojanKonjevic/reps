...
body{background:#080807;color:#f0ede6;font-family:"IBM Plex Serif",Georgia,serif;line-height:1.6;padding:40px 24px 90px;}
...
.sub{font-family:"IBM Plex Sans",sans-serif;color:#b0aca2;margin-bottom:26px;}
h2{font-size:1.35rem;margin:34px 0 10px;color:#f0ede6;}
.card{background:#111010;border:1px solid #232120;border-radius:14px;padding:16px;margin:12px 0;}
...
.minititle span{font-family:"JetBrains Mono",monospace;color:#b0aca2;flex:none;}
button.chip.mini{border:1px solid #232120;font-weight:600;}
...
.cap{font-family:"IBM Plex Sans",sans-serif;font-size:.88rem;color:#b0aca2;margin-top:10px;}
.notes{font-family:"IBM Plex Sans",sans-serif;font-size:.88rem;color:#b0aca2;margin-top:10px;}
...
.cal .cd{min-height:36px;height:36px;width:36px;margin:0 auto;border-radius:9px;display:flex;align-items:center;justify-content:center;color:#7f7a6e;position:relative;text-decoration:none;font-weight:500;}
.cal a.cd.t{background:#3d9a42;color:#fff;font-weight:600;}
.cal a.cd.t:hover{background:#4cb052;text-decoration:none;}
...
.cal .prt{position:absolute;top:-6px;right:-8px;width:13px;height:13px;color:#e6c400;pointer-events:none;}
...
.iconbtn{display:inline-flex;padding:8px;border-radius:10px;color:#f0ede6;}
...
.prbadge{display:inline-flex;vertical-align:-2px;margin-left:6px;color:#e6c400;}
.prbadge svg{width:14px;height:14px;display:block;}
a{color:#f2a35e;text-decoration:none;}
...
.setnotes{margin-top:8px;font-size:.82rem;font-family:"IBM Plex Sans",sans-serif;color:#b0aca2;}
...
td,th{padding:7px 10px;border-bottom:1px solid #232120;text-align:left;}
thead th{font-size:.75rem;letter-spacing:.08em;text-transform:uppercase;color:#b0aca2;}
.empty{font-family:"IBM Plex Sans",sans-serif;color:#6e695c;padding:18px 4px;}
.tip{position:fixed;z-index:60;pointer-events:none;background:#171514;border:1px solid #3a3733;border-radius:10px;padding:8px 12px;font-family:"IBM Plex Sans",sans-serif;font-size:.82rem;box-shadow:0 8px 24px rgba(0,0,0,.18);max-width:260px;color:#f0ede6;}
