...
Higher frequency mainly matters when weekly volume exceeds ~15 sets/muscle; below that, 1x and 2x are similar. 3 on 1 off with push/pull/legs yields 2x/week per muscle — inside the settled range.
...
|----------|------|--------|
| 0–2 RIR (RPE 8–10) for hypertrophy | Settled | Helms 2016, 2018; Krieger 2020 review |
...
| Every set to failure (your style) → manage volume down | Opinion | Your data will show recoverable volume |
...
2.5 kg jumps on upper compounds = ~2–3% at 80–100 kg loads (intermediate range). 5 kg on legs = ~2–4% at 100–150 kg. Your peak guardrail "no 120 after 100 best" aligns: 20% jump is a leap at any level.
...
| Your 3 on 1 off: passive deload every 4th day, active every 4–6 weeks | Opinion | Fits your schedule |
...
| Your interchangeable slots (flies/pec deck) — both shortened, add lengthened if gap | Opinion | Cable fly, machine pullover, DB pullover |

## Personal deviations

None recorded yet. Add here when your data or stated opinion diverges from above. Format: date, deviation, reasoning, confidence.

Example format:
- Sep 17 2026: bench responds better to 3x/week than 2x at equal volume (my data), Opinion